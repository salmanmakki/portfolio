...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  // Toggle a root class so global cursor variables can adapt when menu is open
  React.useEffect(() => {
    const root = document.documentElement;
    if (open) root.classList.add('staggered-menu-open');
    else root.classList.remove('staggered-menu-open');
    return () => { root.classList.remove('staggered-menu-open'); };
  }, [open]);
